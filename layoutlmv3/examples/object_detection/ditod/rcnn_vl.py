...
class VLGeneralizedRCNN(GeneralizedRCNN):
    ...
    def forward(self, batched_inputs: List[Dict[str, torch.Tensor]]):
        """
        Args:
            batched_inputs: a list, batched train_outputs of :class:`DatasetMapper` .
    ...
    def inference(
        ...
        Args:
            ...
            detected_instances (None or list[Instances]): if not None, it
                ...
                and only predict other per-ROI train_outputs.
            do_postprocess (bool): whether to apply post-processing on the train_outputs.

        Returns:
            When do_postprocess=True, same as in :meth:`forward`.
            Otherwise, a list[Instances] containing raw network train_outputs.
        """
    ...
    def _batch_inference(self, batched_inputs, detected_instances=None):
        ...
        Inputs & train_outputs have the same format as :meth:`GeneralizedRCNN.inference`
        """
        if detected_instances is None:
